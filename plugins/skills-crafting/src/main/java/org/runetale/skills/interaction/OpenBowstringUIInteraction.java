...
/**
 * Item interaction that opens the Stringing fletching UI page.
 *
 * <p>
 * Registered as {@code "runetale_open_bowstring"}. Triggered by right-clicking while holding a bowstring or crossbowstring.
 */
public final class OpenBowstringUIInteraction extends SimpleInstantInteraction {
	...
	protected void firstRun(
		...
		FletchingPage page = new FletchingPage(
				...
				List.of("RuneTale_Fletching_Stringing"));
