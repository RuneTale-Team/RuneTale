...
/**
 * Item interaction that opens the Headless Arrows fletching UI page.
 *
 * <p>
 * Registered as {@code "runetale_open_headless_arrow"}. Triggered by right-clicking while holding a headless arrow.
 */
public final class OpenHeadlessArrowUIInteraction extends SimpleInstantInteraction {

	public static final String TYPE_NAME = "runetale_open_headless_arrow";

	public static final BuilderCodec<OpenHeadlessArrowUIInteraction> CODEC = BuilderCodec
			.builder(OpenHeadlessArrowUIInteraction.class, OpenHeadlessArrowUIInteraction::new, SimpleInstantInteraction.CODEC)
			.build();
	...
	protected void firstRun(
		...
		if (runtimeApi == null || craftingRuntime == null) {
			LOGGER.atWarning().log("Skills runtime not available; cannot open headless arrow UI");
			ctx.getState().state = InteractionState.Failed;
			return;
		}
		...
		FletchingPage page = new FletchingPage(
				...
				List.of("RuneTale_Fletching_Tipping"));
